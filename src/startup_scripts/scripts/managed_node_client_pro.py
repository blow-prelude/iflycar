...
"""Pro variant of managed_nodes_client.py.

Manages the pro startup chain (start_all_pro.launch), where the line-following
controller is vision_line_node_fixed_pro (radar-avoidance version). Service
names are unchanged because the node is still launched as "vision_line_node".
...
class ManagedNodesClient:
    def __init__(self) -> None:
        ...
        rospy.loginfo("Managed-node control service (pro) is ready")
