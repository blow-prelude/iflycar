...
# 启动 vision_line2
echo "正在启动 ourgoal vision_line2..."
xfce4-terminal --tab --title="vision_line2" --command "bash -c 'source ~/ucar_ws/devel/setup.bash; rosrun ourgoal vision_line2; exec bash'"
sleep 3

# 启动 RG.py
echo "正在启动 RG.py..."
xfce4-terminal --tab --title="RG" --command "bash -c 'source ~/ucar_ws/devel/setup.bash; source ~/venv3.9/bin/activate; python /home/ucar/ucar_ws/src/vision_ros/scripts/RG.py; exec bash'"
sleep 2
