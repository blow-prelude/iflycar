...
class UcarCamera:
    def __init__(self):
        self.mtx = np.array(
            [
                [408.41864465257, 0, 309.7039339414456], 
                [0, 406.0509463667899, 272.3979542024044],
                [0, 0, 1],
            ]
        )  # 内参数矩阵
        self.dist = np.array(
            [[-0.2816538317937755, 0.06677467622710392, -0.007883381249276117, 0.000701423277555337, 0]]
        )  # 畸变系数
